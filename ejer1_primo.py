...
class NumeroPerfecto:
    ...
    def perfectos_en_rango(self, *args):
        perfectos = []

        for num in args:
            if self.es_perfecto(num):
                perfectos.append(num)
                NumeroPerfecto.numeros_perfectos.append(num)
    ...
    @staticmethod
    def get_perfectos_verificados():
        return len(NumeroPerfecto.numeros_perfectos)


# Crear objeto
perfecto1 = NumeroPerfecto()


if perfecto1.es_perfecto(6):
    print("El número 6 es perfecto")
    NumeroPerfecto.numeros_perfectos.append(6)
else:
    print("El número 6 no es perfecto")


print(perfecto1.perfectos_en_rango(8, 6, 10, 28))


print(perfecto1.historial)


print(perfecto1.cantidad_verificados())


perfecto2 = NumeroPerfecto()

if perfecto2.es_perfecto(28):
    print("El número 28 es perfecto")
    NumeroPerfecto.numeros_perfectos.append(28)
else:
    print("El número 28 no es perfecto")


print(perfecto2.historial)


print(NumeroPerfecto.numeros_perfectos)
